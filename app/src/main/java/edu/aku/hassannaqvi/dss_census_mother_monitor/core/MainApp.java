...
import edu.aku.hassannaqvi.dss_census_mother_monitor.activities.EndingActivity;
...
public class MainApp extends Application {
    ...
    public static final String _HOST_URL = "http://" + MainApp._IP + ":" + MainApp._PORT + "/dssmonitor/api/";
